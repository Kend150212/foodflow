...
<body class="bg-gray-50 min-h-screen">
    ...
    <aside class="fixed inset-y-0 left-0 w-64 bg-gray-900 text-white p-6 hidden lg:block">
        <div class="flex items-center gap-3 mb-8">
            <div class="w-10 h-10 bg-red-600 rounded-lg flex items-center justify-center">📊</div>
        ...
        <nav class="space-y-1">
            ...
            <a href="reports.php" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-gray-800 text-white">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        new Chart(revenueCtx, {
            ...
            data: {
                labels: <?= json_encode(array_map(function ($d) {
                    return date('M j', strtotime($d['date'])); }, $dailyRevenue)) ?>,
                datasets: [{
                    label: 'Revenue',
